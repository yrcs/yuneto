...
var file_conf_conf_proto_goTypes = []interface{}{
	(*Bootstrap)(nil),           // 0: hospital.internal.conf.Bootstrap
	(*Server)(nil),              // 1: hospital.internal.conf.Server
	(*Data)(nil),                // 2: hospital.internal.conf.Data
	(*Server_HTTP)(nil),         // 3: hospital.internal.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 4: hospital.internal.conf.Server.GRPC
	(*Data_Database)(nil),       // 5: hospital.internal.conf.Data.Database
	(*durationpb.Duration)(nil), // 6: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1, // 0: hospital.internal.conf.Bootstrap.server:type_name -> hospital.internal.conf.Server
	2, // 1: hospital.internal.conf.Bootstrap.data:type_name -> hospital.internal.conf.Data
	3, // 2: hospital.internal.conf.Server.http:type_name -> hospital.internal.conf.Server.HTTP
	4, // 3: hospital.internal.conf.Server.grpc:type_name -> hospital.internal.conf.Server.GRPC
	5, // 4: hospital.internal.conf.Data.database:type_name -> hospital.internal.conf.Data.Database
	6, // 5: hospital.internal.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	6, // 6: hospital.internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
